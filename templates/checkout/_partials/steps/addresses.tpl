  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><i class="fi-br-map-marker-plus"></i>{l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>

        {if $use_same_address && !$cart.is_virtual}
          <br />
          <p class="billing-different">
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}"><i class="fi-br-map-marker-plus"></i>{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
