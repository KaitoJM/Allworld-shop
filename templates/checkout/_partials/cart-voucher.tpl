          ...
          <div class="promo-code">
            {block name='cart_voucher_form'}
              <form action="{$urls.pages.cart}" data-link-action="add-voucher" method="post">
                ...
                <input class="promo-input" type="text" name="discount_name" placeholder="{l s='Enter voucher code' d='Shop.Theme.Checkout'}">
                  ...
                  <div class="float-xs-right">
                    <span>{$voucher.reduction_formatted}</span>
                      {if isset($voucher.code) && $voucher.code !== ''}
                        <a href="{$voucher.delete_url}" data-link-action="remove-voucher"><i class="fi-br-trash"></i></a>
                      {/if}
                  </div>
                </li>
              {/foreach}
